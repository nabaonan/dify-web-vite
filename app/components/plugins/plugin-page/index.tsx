          ...
          <div className='flex shrink-0 items-center gap-1'>
            {
              isExploringMarketplace && (
                <>
                  <Link to='https://github.com/langgenius/dify-plugins/issues/new?template=plugin_request.yaml'
                    target='_blank'
                  >
                    <Button
                      variant='ghost'
                  ...
                  <Link to={getDocsUrl(locale, '/plugins/publish-plugins/publish-to-dify-marketplace/README')}
                    target='_blank'
                  >
                    <Button
                      className='px-3'
